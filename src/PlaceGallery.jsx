    ...
    return (
      <div className="container items-center justify-center">
        <div className="absolute inset-0 bg-black text-white">
          <div className="bg-gray-200 p-12 grid gap-4">
            <div>
              <h2 className="text-3xl text-black">Photos of {place.title}</h2>
              <button
                onClick={() => setShowAllPhotos(false)}
                className="fixed right-12 top-8 flex gap-1 py-2 px-4 rounded-2xl shadow shadow-white bg-white text-black"
              >
                <svg
